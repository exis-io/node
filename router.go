...
// // A Node handles new Peers and routes requests to the requested Realm.
// type Node interface {
// 	Accept(Peer) error
// 	Close() error
...
// // DefaultNode is the default WAMP Node implementation.
...
// func (n *defaultNode) cb(args []interface{}, kwargs map[string]interface{}) {
...
// func (r *defaultNode) AddSessionOpenCallback(fn func(uint, string)) {
// 	r.sessionOpenCallbacks = append(r.sessionOpenCallbacks, fn)
// }

// func (r *defaultNode) AddSessionCloseCallback(fn func(uint, string)) {
// 	r.sessionCloseCallbacks = append(r.sessionCloseCallbacks, fn)
// }

// func (r *defaultNode) Close() error {
// 	r.closeLock.Lock()
...
// func (r *defaultNode) RegisterRealm(uri URI, realm Realm) error {
...
// func (r *defaultNode) Accept(client Peer) error {
// 	//log.Println("Accepting a new connection from ", client)

// 	if r.closing {
// 		logErr(client.Send(&Abort{Reason: ErrSystemShutdown}))
// 		logErr(client.Close())
// 		return fmt.Errorf("Node is closing, no new connections are allowed")
// 	}
...
// func (r *defaultNode) GetLocalPeer(realmURI URI, details map[string]interface{}) (Peer, error) {
...
// func (r *defaultNode) getTestPeer() Peer {
// 	peerA, peerB := localPipe()
// 	go r.Accept(peerA)
// 	return peerB
// }
